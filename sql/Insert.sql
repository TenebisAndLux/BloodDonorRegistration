-- Insert 5 donors into the Donors table
...
VALUES
    ('John', 'Doe', 'l', '1990-05-15', 'M', '123 Main St', '555-1234', 'St. Mary Hospital', 'ABC123456', 'Some Insurance Company', 'A', '+'),
    ('Jane', 'Doe', 'x', '1985-06-20', 'F', '456 Oak St', '555-9876', 'St. John Hospital', 'CD123456', 'Another Insurance Company', 'B', '-'),
    ('Jack', 'Smith', NULL, '1975-07-10', 'M', '789 Maple St', '555-5678', 'St. Mary Hospital', 'EF123456', 'Some Insurance Company', 'AB', '+'),
    ('Jill', 'Smith', 'y', '1995-12-05', 'F', '321 Elm St', '555-1472', 'St. John Hospital', 'GH123456', 'Another Insurance Company', 'A', '-'),
    ('James', 'Johnson', 'z', '1980-08-15', 'M', '951 Oak Ave', '555-9012', 'St. Mary Hospital', 'IJ123456', 'Some Insurance Company', 'O', '+');
